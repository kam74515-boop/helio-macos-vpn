...
export const iconMap = {
  ...
  // Extended icons for process/app matching
  music_note: MuiIcons.MusicNoteRounded,
  videocam: MuiIcons.VideocamRounded,
  mail: MuiIcons.MailRounded,
  sports_esports: MuiIcons.SportsEsportsRounded,
  account_balance: MuiIcons.AccountBalanceRounded,
  location_on: MuiIcons.LocationOnRounded,
  shopping_cart: MuiIcons.ShoppingCartRounded,
  menu_book: MuiIcons.MenuBookRounded,
  newspaper: MuiIcons.NewspaperRounded,
  calendar_today: MuiIcons.CalendarTodayRounded,
  schedule: MuiIcons.ScheduleRounded,
  wb_sunny: MuiIcons.WbSunnyRounded,
  translate: MuiIcons.TranslateRounded,
  calculate: MuiIcons.CalculateRounded,
  folder: MuiIcons.FolderRounded,
  help: MuiIcons.HelpRounded,
  download: MuiIcons.DownloadRounded,
  cloud_upload: MuiIcons.CloudUploadRounded,
  print: MuiIcons.PrintRounded,
  document_scanner: MuiIcons.DocumentScannerRounded,
  vpn_key: MuiIcons.VpnKeyRounded,
  folder_open: MuiIcons.FolderOpenRounded,
  swap_vert: MuiIcons.SwapVertRounded,
  code: MuiIcons.CodeRounded,
  table_chart: MuiIcons.TableChartRounded,
  slideshow: MuiIcons.SlideshowRounded,
  picture_as_pdf: MuiIcons.PictureAsPdfRounded,
  storage: MuiIcons.StorageRounded,
  dns: MuiIcons.DnsRounded,
  receipt_long: MuiIcons.ReceiptLongRounded,
  backup: MuiIcons.BackupRounded,
  system_update: MuiIcons.SystemUpdateRounded,
